<template>
  ...
  >
    ...
    <div class="list-fixed" ref="fixed" v-show="fixedTitle">
      <div class="fix-title">{{fixedTitle}}</div>
    </div>
  ...
  export default {
    ...
    methods: {
      ...
      onShortcutTouchMove (e) {
        ...
        let count = (this.touch.y2 - this.touch.y1) / shortcutHeight | 0
        let anchorIndex = parseInt(this.touch.anchorIndex) + count
        this._scrollTo(anchorIndex)
      },
      scroll (pos) {
        this.scrollY = pos.y
    ...
    watch: {
      ...
      dif (newDif) {
        let fixedTop = (newDif > 0 && newDif < titleHeight) ? newDif - titleHeight : 0
